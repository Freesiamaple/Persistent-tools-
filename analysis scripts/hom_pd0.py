...
H = ax.hist2d(x,y, bins=[np.linspace(xlim[0],xlim[1],(xlim[1]-xlim[0])*2),np.linspace(ylim[0],ylim[1],(ylim[1]-ylim[0])*2)], norm=matplotlib.colors.LogNorm(), cmap=cm.rainbow,vmin=10**0,vmax=10**4)
plt.minorticks_on()
